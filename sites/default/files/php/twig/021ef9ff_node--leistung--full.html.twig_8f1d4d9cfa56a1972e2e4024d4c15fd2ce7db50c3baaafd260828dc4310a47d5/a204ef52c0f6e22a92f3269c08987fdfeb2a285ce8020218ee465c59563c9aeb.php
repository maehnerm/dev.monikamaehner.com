...
/* themes/moma/templates/node--leistung--full.html.twig */
class __TwigTemplate_8c6cbed407d921ae2ef8e5cc852a92b90417b0889caf56616550eda6eb0288fb extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $filters = array("without" => 91, "length" => 99);
        $functions = array();
        ...
        echo "\" ";
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", array(0 => "text-center"), "method"), "html", null, true));
        echo ">
  ...
  ";
        ...
        // line 90
        echo "  <div";
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute((isset($context["content_attributes"]) ? $context["content_attributes"] : null), "addClass", array(0 => "text-center"), "method"), "html", null, true));
        echo ">
    ";
        // line 91
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, twig_without((isset($context["content"]) ? $context["content"] : null), "comment", "links", "field_tags", "field_thumbnail"), "html", null, true));
        echo "
  </div>
  ";
        // line 93
...
";
    ...
    {
        return "themes/moma/templates/node--leistung--full.html.twig";
    }
    ...
    {
        return array (  140 => 104,  136 => 103,  133 => 102,  127 => 100,  125 => 99,  122 => 98,  116 => 95,  113 => 94,  111 => 93,  106 => 91,  101 => 90,  99 => 89,  91 => 85,  89 => 84,  85 => 83,  81 => 82,  78 => 81,  76 => 80,  70 => 78,  62 => 75,  57 => 74,  55 => 73,  51 => 72,  43 => 70,);
    }
}
/* {#*/
/* /***/
...
/*  *//* */
/* #}*/
/* <article id="node-{{ node.id }}" {{ attributes.addClass('text-center') }}>*/
/* */
/*   {{ title_prefix }}*/
/*   {% if not page %}*/
/*     <h1{{ title_attributes }}>*/
...
/*   <div{{ content_attributes.addClass('text-center') }}>*/
/*     {{ content|without('comment', 'links', 'field_tags','field_thumbnail') }}*/
/*   </div>*/
